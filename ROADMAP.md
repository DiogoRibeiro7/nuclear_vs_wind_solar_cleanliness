...
- [x] Extend lifecycle and non-carbon metrics by geography, grid context, and deployment year. *(`energy_cleanliness.geography` + `data/grid_carbon_intensity.csv`; marginal abatement by region × year; `scripts/run_geography_analysis.py`.)*
